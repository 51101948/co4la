<div class="product-item col-xs-6 col-sm-6 col-md-4">
	<a href="/product/detail/{{$product->slug}}">
		<div class="product-info col-xs-12 col-sm-12 col-md-12">
			<div class="product-img col-xs-12 col-sm-12 col-md-12" style="padding: 0px; margin-bottom: 3px; max-height: 169px;">
				<img src="{{$product->path}}" style="border-top-right-radius:10px; border-top-left-radius:10px; padding: 0px; height: 169px; /*width:100%;*/" class="col-xs-12 col-sm-12 col-md-12">
			</div>
